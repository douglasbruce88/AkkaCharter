...
module Form = 
    ...
    let btnRunTasks = new Button(Name = "btnRunTasks", Text = "Run using Tasks", Location = Point(20, 300), Size = Size(110, 41), TabIndex = 1, UseVisualStyleBackColor = true)
    ...
    let listBox = new ListBox(Location = new Point(20, 30), FormattingEnabled = true, SelectionMode = SelectionMode.MultiExtended, Height = 150)
